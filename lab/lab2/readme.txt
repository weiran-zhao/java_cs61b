...
the case of f0, we have invoked the toString method, which you should look at.
...
form; instead, gcd always returns 1.  Rewrite the body of gcd so that it is a
recursive function that correctly computes the GCD.  Recompile and run your
program.
