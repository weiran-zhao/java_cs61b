...
// Tue,Jun 18th 2013 02:04:28 PM EDT
...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
        ...
        DListNode tmp = ((DList) myList).newNode(item, (DList) myList, this, this.next);
        this.next.prev=tmp;
        this.next=tmp;
        this.myList.size+=1;
    }
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   new node.
        ...
        DListNode tmp = ((DList)myList).newNode(item, (DList)myList,this.prev,this);
        this.prev.next=tmp;
        this.prev=tmp;
        this.myList.size+=1;
    }
