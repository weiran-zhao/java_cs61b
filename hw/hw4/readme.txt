                               CS 61B Homework 4
                       Due 5:30pm Friday, March 1, 2013
...
named GRADER (which will be submitted with your code).  You should assume that
the application is NOT in the list package (which would be a remarkably
...
if you name it GRADER.txt or something like that.  It won't take "grader"
